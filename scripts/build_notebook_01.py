...
CELL3_CODE = [
    ...
    "# The GitHub repo may contain ONLY the initial 'chore: prepare OSS release",
    "# metadata' commit (LICENSE + README + .gitignore) until you push your code.",
    "# If setup.py and src/ are absent we abort with the exact commands you need",
    "# to run on a GitHub-authenticated shell (laptop, workstation, etc.) to push.",
    ...
    "    print('  git add -A && git commit -m \"Phase 1 training code\"')",
    "    print('  git push -u origin main\n')",
    "    print('If you do not have GitHub auth yet:')",
    "    print('  1. Create a Personal Access Token at https://github.com/settings/tokens')",
    "    print('  2. gh auth login                  # one-time browser flow')",
    "    print('  3. OR: export GH_TOKEN=$(awk \'/oauth_token:/{print $NF}\' ~/.config/gh/hosts.yml)\n')",
